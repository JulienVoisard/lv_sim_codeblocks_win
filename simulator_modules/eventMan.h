...
typedef enum
{
	...
	EVENT_TYPE_reset_alarm_machine,
	EVENT_TYPE_alarm_bar_feeder, // bar feeder security line has been opened
	EVENT_TYPE_reset_alarm_bar_feeder,
	EVENT_TYPE_alarm_air,
	EVENT_TYPE_reset_alarm_air,
	EVENT_TYPE_alarm_modbus_com,
	EVENT_TYPE_piece_done,
	EVENT_TYPE_command_stop,
	EVENT_TYPE_command_setup_diagram,
	...
	EVENT_TYPE_loading_start,   // Loading start
